        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-sm-12 col-sm-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Dane Odbiorców<small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left">
                                        ...
                                        <table class="table table-striped jambo_table bulk_action table-bordered">
                                            ...
                                            @foreach($dane as $item)
                                                <tr class="even pointer">
                                                    ...
                                                    <td> <a class="btn btn-primary" href={{route('firmsender.edit', $item)}}>Edytuj</a></td>
                                                    <td>
                                                        {!! Form::model($item, ['route' => ['firmsender.destroy', $item], 'method' => 'DELETE']) !!}
                                ...
                                <div class="x_content">
                                    {!! Form::close() !!}
                                    <a href="{{ URL::route('firmsender.create') }}" type="button" class="btn btn-dark">Dodaj</a>
                                </div>
                            </form>
                        </div>
                    </div>
